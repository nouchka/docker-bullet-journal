  ...
  <footer id="collection-options" class="footer-options">
    <div class="container">
      <div class="option-container">
        <div
          class="option-btn option-category"
          @click="filtering('', '')"
          title="Filter: Click to Clear"
        >
          <v-icon name="filter" class="btn-icon" />
        </div>
        <div
          class="option-btn"
          @click="filtering('type', 'event')"
          title="By Events"
        >
          <v-icon
            name="calendar-day"
            class="btn-icon"
            :class="{ active: filterConditions.value === 'event' }"
          />
        </div>
        <div
          class="option-btn"
          @click="filtering('type', 'todo')"
          title="By Todos"
        >
          <v-icon
            name="tasks"
            class="btn-icon"
            :class="{ active: filterConditions.value === 'todo' }"
          />
        </div>
        <div
          class="option-btn"
          @click="filtering('type', 'general')"
          title="Other lists"
        >
          <v-icon
            name="list"
        ...
        <div
          class="option-btn"
          @click="filtering('completed', false)"
          title="In Progress"
        >
          <v-icon
            name="square"
            class="btn-icon outline"
            :class="{ active: filterConditions.value === false }"
          />
        </div>
        <div
          class="option-btn"
          @click="filtering('completed', true)"
          title="Completed"
        >
          <v-icon
            name="check-square"
            class="btn-icon"
            :class="{ active: filterConditions.value === true }"
          />
        </div>
      ...
      <div class="option-container">
        <div
          class="option-btn option-category"
          title="Sort: Click to Clear"
          @click="changeSort('FIFO')"
        >
          <v-icon name="sort" class="btn-icon" />
        </div>
        <div
          class="option-btn"
          title="By Date Created: Newest to Oldest"
          @click="changeSort('createdLIFO')"
        >
          <v-icon
            name="calendar-plus"
            class="btn-icon"
            :class="{ active: sortConditions === 'createdLIFO' }"
          />
        </div>
        <div
          class="option-btn"
          title="By Due Date: Earliest to Latest"
          @click="changeSort('dueLIFO')"
        >
          <v-icon
            name="calendar-check"
            class="btn-icon"
            :class="{ active: sortConditions === 'dueLIFO' }"
          />
        </div>
        <div
          class="option-btn"
        ...
        >
          <v-icon
            ...
            class="btn-icon"
            :class="{ active: sortConditions === 'asc' }"
          />
        </div>
      </div>
    </div>
